...
This pattern is used when the horizontal space is limited. By default, Aside navigation is collapsed and you can click the button at the bottom to expand it.
